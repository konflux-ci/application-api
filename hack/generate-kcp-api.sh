...
KCP_API_SCHEMA_FILE_CURRENT="${KCP_API_DIR}/apiresourceschema.yaml"
KCP_API_SCHEMA_FILE_NEW="${KCP_API_DIR}/apiresourceschema.yaml_new"
...
KCP_API_EXPORT_FILE="${KCP_API_DIR}/apiexport.yaml"
