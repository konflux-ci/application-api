...
type DeploymentTargetClaimSpec struct {
	DeploymentTargetClassName DeploymentTargetClassType `json:"deploymentTargetClassName"`
}

type DeploymentTargetClassType string

const (
	DTCType_IsolationLevelNamespace DeploymentTargetClassType = "isolation-level-namespace"
)
